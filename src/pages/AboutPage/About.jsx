        ...
        <div className="max-w-7xl mx-auto relative z-10" data-aos="fade-up">
          <div className="text-center mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Empowering students with AI-powered wellness monitoring, inclusive
              communication, collaborative learning spaces, and centralized
              campus engagement.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-4">
                Modern campuses are hubs of learning, social interaction, and
                personal growth. However, students face significant challenges
                including rising stress and anxiety, fragmented collaboration
                tools, distracting communication platforms, and scattered campus
                information.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300">
                Synapse Synchrony addresses these challenges by providing a
                comprehensive platform that integrates mental wellness support,
                inclusive communication, collaborative workspaces, and
                centralized campus engagement—all in one place.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4" data-aos="fade-left">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Accessible to all students and abilities
                </p>
              </div>
              <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Intelligent features for better outcomes
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    AI-powered mental wellness monitoring with non-invasive
                    assessment, stress/mood analytics, and proactive
                    interventions.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Real-time encrypted chat with accessibility features
                    including sign language-to-text and speech translation for
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Collaborative whiteboard channels with file sharing, version
                    control, inline comments, and AI-powered note summarization.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Dynamic campus hub for events, lost-and-found,
                    announcements, and blogs to foster community engagement.
                  </p>
                </div>
              </div>
            </div>
