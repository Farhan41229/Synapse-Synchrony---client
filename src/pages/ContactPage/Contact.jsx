          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div data-aos="fade-right">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                Have questions about Synapse Synchrony? Want to provide feedback
                or report an issue? We're here to help!
              </p>
              ...
              <div className="mt-8 p-6 rounded-xl bg-gradient-to-br from-[#04642a]/10 to-[#15a33d]/5 dark:from-[#04642a]/20 dark:to-[#15a33d]/10 border border-[#04642a]/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  business days. For urgent matters, please mark your message as
                  priority.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Absolutely! Synapse Synchrony is fully responsive and works on
                all devices.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Navigate to the chat section and select "Whoop AI" from your
